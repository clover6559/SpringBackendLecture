package com.example.javathreadbasicdemo.practice05;
...
public class SynchronizedComparisonDemo {
    ...
    private static void demonstrateMethodSynchronization() {
        ...
        runPerformanceTest(counter::increment, "MethodSync");
    }
    ...
    private static void demonstrateBlockSynchronization() {
        ...
        runPerformanceTest(counter::increment, "BlockSync");
    }
    private static void runPerformanceTest(Runnable incrementLogic, String testName) {
        int threadCount = 10;
        ...
        System.out.println(testName + " 총 소요 시간: " + (endTime - startTime)+ "ms");
    }
