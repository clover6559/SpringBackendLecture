...
public class UserController {
    ...
    public Map<String, Object> success() {
        System.out.println(now() + " [UserController] 성공 요청");
        userService.registerSuccessUser("success@test.com");
        return Map.of("success", true);
    }

    @GetMapping("/api/users/fail")
    public Map<String, Object> fail() {
        System.out.println(now() + " [UserController] 실패 요청");
        userService.registerFailUser("fail@test.com");
