...
public class ProductService {
    ...
    @Cacheable(key = "#id", condition = "#id>0", unless = "#result.contains('미판매')")
    ...
    @Cacheable(value = "productsByMethod", key = "#root.methodName + '_' + #id")
    ...
    @Cacheable(value = "productsByClass", key = "#root.targetClass.simpleName + '_' + #id")
    ...
    @Cacheable(value = "productsByCustomGenerator", keyGenerator = "customKeyGenerator")
    ...
    public String updateComplexCache(Long id, String name) {
