...
public class ProductController {
    ...
    public Map<String, Object> getMethodProduct(
        ...
        return Map.of("result", productService.getProductByMethod(id)
        );
    }
    ...
    public Map<String, Object> getClassProduct(
        ...
        return Map.of("result", productService.getProductByClass(id));
    }
    ...
    public Map<String, Object> getGeneratorProduct(
        ...
        return Map.of("result",productService.getProductByGenerator(id));
    }
    ...
    public Map<String, Object> updateComplexCache(
        ...
        return Map.of("result", productService.updateComplexCache(id, name));
    }
