...
public class RestFulApiProductController {
    ...
    public EntityModel<RestFulApiProductResponse> getProduct(@PathVariable Long id) {
        ...
        return EntityModel.of(product, linkTo(methodOn(RestFulApiProductController.class).getProduct(id)).withSelfRel(),
    ...
    public CollectionModel<RestFulApiProductResponse> getAllProducts() {
        ...
        return CollectionModel.of(list, linkTo(methodOn(RestFulApiProductController.class).getAllProducts()).withSelfRel());
    }
}
